...
import com.synapse.social.studioasinc.presentation.editprofile.components.EditProfileTopBar
...
fun EditProfileScreen(
    ...
    SynapseTheme {
        ...
        if (uiState.showShareToFeedDialog) {
            AlertDialog(
                onDismissRequest = { viewModel.onEvent(EditProfileEvent.DismissShareToFeedDialog) },
                ...
                confirmButton = {
                    TextButton(
                        onClick = {
                            ...
                            viewModel.onEvent(EditProfileEvent.DismissShareToFeedDialog)
                        }
                    ) {
                ...
                dismissButton = {
                    TextButton(
                        onClick = { viewModel.onEvent(EditProfileEvent.DismissShareToFeedDialog) }
                    ) {
